          ...
          <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow p-6">
              ...
              <button
                ...
                class="mt-6 px-6 py-2 bg-amber-600 text-white rounded-xl hover:bg-amber-700 transition"
              >
                ✏️ Edit Profil
              </button>
            </div>
            ...
            <div class="bg-white rounded-xl shadow p-6">
              ...
              <div class="space-y-4">
                <div class="flex justify-between items-center p-4 border border-gray-200 rounded-xl">
                  ...
                  <button class="px-4 py-2 bg-gray-600 text-white rounded-xl hover:bg-gray-700 transition">
                    Ubah
                  </button>
                </div>
        ...
        <div class="bg-white rounded-xl shadow p-6">
          ...
          <div class="space-y-4">
            <div
              ...
              :key="activity.id"
              class="flex gap-4 p-4 border border-gray-200 rounded-xl hover:border-amber-300 transition"
            >
