      ...
      <main class="flex-1 bg-gray-50 p-8">
        ...
        <div v-if="showForm" class="bg-white rounded-xl shadow p-6 mb-8">
          ...
          <div class="mb-8 p-6 border border-gray-200 rounded-xl">
            ...
            <div
              ...
              :key="index"
              class="mb-6 p-4 border border-gray-100 rounded-xl"
            >
          ...
          <div class="flex gap-4 pt-6 border-t border-gray-200">
            <button
              @click="saveStructure"
              :disabled="isSaving"
              class="px-6 py-2 bg-green-600 text-white rounded-xl hover:bg-green-700 transition disabled:bg-gray-400"
            >
        ...
        <div class="bg-white rounded-xl shadow p-6">
          ...
          <div class="text-center mb-8">
            <div class="inline-block bg-amber-100 text-amber-900 rounded-xl p-6">
