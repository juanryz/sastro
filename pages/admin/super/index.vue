  ...
  <div>
    ...
    <div class="flex">
        ...
        <nav class="space-y-4">
          ...
          <div>
            <button
              ...
              class="w-full text-left px-4 py-3 rounded-sm hover:bg-gray-800 transition font-semibold"
            >
            ...
            <div v-if="expandMenu === 'users'" class="ml-4 space-y-2 mt-2">
              <NuxtLink
                ...
                class="block px-4 py-2 rounded-sm hover:bg-gray-800 transition text-sm"
              >
                Admin Users
              </NuxtLink>
              <NuxtLink
      ...
      <main class="flex-1 bg-gray-50 p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="bg-white rounded-sm shadow p-6">
            ...
            <div class="space-y-2">
              <NuxtLink
                to="/admin/super/admin-users"
                class="block w-full px-4 py-2 bg-purple-600 text-white rounded-sm hover:bg-purple-700 transition text-center font-semibold"
              >
                Kelola Admin
              </NuxtLink>
              <NuxtLink
                to="/admin/super/members"
                class="block w-full px-4 py-2 bg-yellow-600 text-white rounded-sm hover:bg-yellow-700 transition text-center font-semibold"
              >
                Verifikasi Member
              </NuxtLink>
            </div>
          ...
          <div class="bg-white rounded-sm shadow p-6">
            ...
            <div class="space-y-2">
              <NuxtLink
                to="/admin/berita"
                class="block w-full px-4 py-2 bg-blue-600 text-white rounded-sm hover:bg-blue-700 transition text-center font-semibold"
              >
                Artikel & Berita
              </NuxtLink>
              <NuxtLink
                to="/admin/super/content"
                class="block w-full px-4 py-2 bg-indigo-600 text-white rounded-sm hover:bg-indigo-700 transition text-center font-semibold"
              >
                Gallery & Media
              </NuxtLink>
            </div>
          ...
          <div class="bg-white rounded-sm shadow p-6">
            ...
            <NuxtLink
              to="/admin/super/organization"
              class="block w-full px-4 py-2 bg-green-600 text-white rounded-sm hover:bg-green-700 transition text-center font-semibold"
            >
              Kelola Organisasi
            </NuxtLink>
          </div>
          ...
          <div class="bg-white rounded-sm shadow p-6">
            ...
            <NuxtLink
              to="/admin/super/settings"
              class="block w-full px-4 py-2 bg-red-600 text-white rounded-sm hover:bg-red-700 transition text-center font-semibold"
            >
              Pengaturan Teknis
            </NuxtLink>
          </div>
        ...
        <!-- Recent Activity -->
        <div class="mt-8 bg-white rounded-sm shadow p-6">
          <h3 class="text-xl font-bold text-gray-900 mb-6">📋 Aktivitas Terbaru</h3>

          <div class="space-y-4">
            <div v-for="activity in recentActivities" :key="activity.id" class="flex items-center gap-4 p-4 border border-gray-200 rounded-sm">
